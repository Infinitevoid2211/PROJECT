          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-3">
            <div className="bg-white border border-slate-200 rounded-xl p-4 shadow-sm">
              ...
              <p className="font-mono font-bold text-2xl text-slate-900">
                {data?.susceptibility_index
                  ? (data.susceptibility_index * 100).toFixed(1) + "%"
                  : `${activeZone.probability}%`}
              </p>
          ...
          <div className="grid lg:grid-cols-2 gap-4">
            ...
            <div className="bg-white border border-slate-200 rounded-xl p-5 shadow-sm">
              <div className="flex items-center justify-between mb-4">
                <div>
                  <h3 className="font-head font-bold text-slate-800 text-sm">
                    ...
                    <>
                      <polygon
                        ...
                        points={`0,180 ${series
                          .map(
                            (p, i) =>
                              `${(i / (series.length - 1)) * 500},${
                                180 -
                                (p.soil_moisture / 100) * 160
                              }`
                          )
                          .join(" ")} 500,180`}
                      />
              ...
              <div className="flex justify-between text-[10px] font-mono text-slate-400 mt-2">
                ...
                <span>
                  {series[series.length - 1]?.time || "Now"}
                </span>
              </div>
            </div>
            ...
            <div className="bg-white border border-slate-200 rounded-xl p-5 shadow-sm">
              <div className="flex items-center justify-between mb-4">
                <div>
                  <h3 className="font-head font-bold text-slate-800 text-sm">
                    Slope Creep & Rainfall Distribution
                  </h3>

                  <p className="text-xs text-slate-500 font-mono">
                    Displacement (mm) vs Precipitation (mm/h)
                  </p>
                </div>
              ...
              <div>
                ...
                <p className="text-xs text-slate-300 mt-0.5">
                  ...
                  <span className="text-amber-300">
                    {activeZone.vulnerable_infra}
                  </span>{" "}
                  · Safe shelter:{" "}
                  <span className="text-emerald-300">
                    {activeZone.safe_shelter}
                  </span>
                </p>
              </div>
            </div>
